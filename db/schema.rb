...
ActiveRecord::Schema.define(version: 20150204164017) do
  ...
  create_table "feature_clusters", force: true do |t|
    t.datetime "created_at"
    t.datetime "updated_at"
  end
  ...
  create_table "features", force: true do |t|
    ...
    t.integer  "genome_id"
    t.hstore   "stats"
    t.integer  "feature_cluster_id"
  end

  add_index "features", ["feature_cluster_id"], name: "index_features_on_feature_cluster_id", using: :btree
